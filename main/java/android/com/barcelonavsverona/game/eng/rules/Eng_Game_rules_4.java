...
public class Eng_Game_rules_4 extends AppCompatActivity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eng__game_rules_4);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_next_eng_slide:
                Intent intent = new Intent(this, Eng_Game_rules_5.class);
                startActivity(intent);
                break;
            case R.id.btn_previous_eng_slide:
                Intent intent2 = new Intent(this, Eng_Game_rules_3.class);
